...
namespace FredsWorkmate.Util
{
    ...
    public static class CurrencyCodeUtil
    {
        public static CurrencyCodes ToCurrencyCodes(CurrencyCode currencyCode)
        {
            return (CurrencyCodes)currencyCode; //cast as values are the same
        }
    }
}
